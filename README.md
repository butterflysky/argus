...
**Coverage**
- Live badge: [coverage.svg](https://butterflysky.github.io/argus/coverage.svg) (JaCoCo, :common; DiscordBridge/SmokeEntry excluded because they require live Discord runtime). Locally: `./gradlew test jacocoTestReport` then open `common/build/reports/jacoco/test/html/index.html`.
