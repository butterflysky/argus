...
- **Role drift detection**: post-join live role check removes/denies access if the whitelist role is missing; if the user left the Discord guild, access is revoked and logged.
